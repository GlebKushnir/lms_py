...
def second_index(text, some_str):
    some_str_first_index = text.find(some_str)
    some_str_second_index = text.find(some_str, some_str_first_index + 1)

    if some_str_second_index == -1:
        return None

    return some_str_second_index
